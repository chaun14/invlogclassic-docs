...
Un message comme celui de dessus n'a pas trop de sens. Vous devriez le personnaliser avec des information du nouveau membre, de la personne qui l'a invité ou encore de votre serveur en utilisant des variables. Vous pouvez voir la liste en [dessous](custom-messages.md#variables).
